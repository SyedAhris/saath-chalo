...
import 'package:flutterdemo/common/intro_screen.dart';
    ...
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
            create: (context) => RideHistoryDetailsProvider()),
        ChangeNotifierProvider(create: (context) => BookedRidesProvider()),
        ChangeNotifierProvider(
            create: (context) => BookedRidesDetailProvider()),
        ChangeNotifierProvider(
            create: (context) => DriverRideHistoryProvider()),
        ChangeNotifierProvider(
            create: (context) => DriverScheduledRidesProvider()),
        ChangeNotifierProvider(
            create: (context) => DriverScheduledRidesDetailedProvider()),
        ChangeNotifierProvider(create: (context) => PassengerRequestProvider()),
        ChangeNotifierProvider(create: (context) => CreateRideProvider()),
      ],
      child: const MyApp(),
    ),
  );
