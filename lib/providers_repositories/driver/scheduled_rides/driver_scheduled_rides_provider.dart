...
class DriverScheduledRidesProvider with ChangeNotifier {
  ...
  final DriverScheduledRideRepository _driverScheduledRideRepository =
      DriverFirebaseScheduledRideRepository();
  ...
  fetchRides(String driverId) async {
    ...
    upcomingRide =
        await _driverScheduledRideRepository.getUpcomingRide(driverId);
    isFetching = false;
    notifyListeners();
  }
}
